...
* Vector font
    ...
    * `vector_font_matrix()`
    * `vector_font_raster()`
* Hide these as internal data
    * `gridfont`, `gridfont_smooth`, `arcade`

### Fonts

Bitmap fonts:

* [Cozette v1.25.2](https://github.com/slavfox/Cozette) License: MIT. See `LICENSE-cozette`
* [Creep2](https://github.com/raymond-w-ko/creep2) License: MIT. See `LICENSE-creep2`
* [Spleen v2.1.0](https://github.com/fcambus/spleen) License: BSD 2-clause. See `LICENSE-spleen`
* [Unifont]() Add to copyright
* [toit]() Add to copyright
...
"spleen-32x64", "spleen-5x8", "spleen-6x12", "spleen-8x16")

create_raster("Hello #RStats!", "spleen-32x64") |> 
...
plot_df <- create_coords(paste(LETTERS, collapse = ""), "unifont")
